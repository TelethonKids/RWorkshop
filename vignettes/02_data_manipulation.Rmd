...
Download the slides from this link: [https://github.com/TelethonKids/RWorkshop/inst/doc](https://github.com/TelethonKids/RWorkshop/inst/doc)
...
tki_demo %>%
  summarise_at(c("male", "day1", "day2", "day3"),
               mean,
               na.rm = T)
...
include_graphics("assets/images/joins.png")
...
```{r summarise_multiple, comment = NA}
tki_demo %>%
