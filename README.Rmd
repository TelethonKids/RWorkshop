---
title: "Telethon Kids Institute R Workshop Resources"
...
Telethon Kids Institute R Workshop slides(.html) can be downloaded directly through the [inst/doc](https://github.com/TelethonKids/RWorkshop/tree/master/inst/doc) directory of this repository.

## Installing

Install the Telethon Kids Institute RWorkshop package by copying the following into the R console:
...
All resources were prepared with the <https://github.com/TelethonKids/biometrics> R-markdown templates.
